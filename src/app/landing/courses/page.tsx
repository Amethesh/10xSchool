...
const coursesData: CourseCardItems[] = [
  {
    ...
    coursePoints: [
      "Abacus (Finger & Mind Abacus) - Perform calculations 5X to 10X faster than traditional methods — a fun and powerful way to develop mental arithmetic skills.",
      "Vedic Math - Learn to solve complex equations in a flash using ancient Indian techniques that enhance both speed and accuracy.",
      "Memory Boosters - Use both hemispheres of the brain to master in memory techniques to memorize faster, retain longer, and recall smarter.",
      "Financial Literacy - Build smart money habits early! Learn to manage money with confidence and responsibility through age-appropriate, practical tools.",
      "Brain Exercises - Engage in puzzles, riddles, and brain games that activate both hemispheres of the brain, promoting lateral and logical thinking.",
    ],
    image: "/images/courses/brain.png",
    imageWidthClass: "w-96",
    bgColor: "bg-[#ccf0ff]",
    brochureUrl: "/pdf/10X-Brochure.pdf",
  },
  {
