  ...
  ({ className, value, children, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={clsx(
          "relative pixel-font text-[8px] sm:text-base tracking-wider whitespace-nowrap px-2 py-3 transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 rounded-t-sm",
...
const TabsContent = React.forwardRef<HTMLDivElement, TabsContentProps>(
  ({ className, value, children, ...props }, ref) => {
    ...
    // Exclude conflicting props that have different signatures between React and Framer Motion
